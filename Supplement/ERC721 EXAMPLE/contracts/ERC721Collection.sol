...
contract ERC721Collection is ERC721, Ownable {
    ...
    // Can only be called once per address , user can mint 1 NFT
    ...
    //     require(_mintAmount < 3); // this check is wrong
    ...
    function setCost(uint256 _cost) public onlyOwner {
        // check if cost is not 0 
        // check if cost is not the same as existing cost
        cost = _cost;
    }
